...
class RegulatoryStatus(str, Enum):
    """Statutory regulatory status under the Insecticides Act 1968 / CIBRC."""
    BANNED_NATIONWIDE = "BANNED_NATIONWIDE"
    BANNED_FOR_CROP = "BANNED_FOR_CROP"
    BANNED_FORMULATION = "BANNED_FORMULATION"
    RESTRICTED_USE = "RESTRICTED_USE"
    RESTRICTED_OPERATOR = "RESTRICTED_OPERATOR"
    REGISTERED_LABEL_USE = "REGISTERED_LABEL_USE"
...
class ReasonCode(str, Enum):
    ...
    UNREGISTERED_LABEL_CLAIM = "UNREGISTERED_LABEL_CLAIM"
    WITHDRAWN = "WITHDRAWN"
    UNKNOWN_REGULATORY_STATUS = "UNKNOWN_REGULATORY_STATUS"

    # Backward compatibility aliases
    BANNED_CHEMICAL = "BANNED_NATIONWIDE"
    RESTRICTED_CHEMICAL = "RESTRICTED_USE"
    ...
    # THUNAI Product-Safety Policy (Independent of Statutory Status)
    THUNAI_SAFETY_POLICY = "THUNAI_SAFETY_POLICY"
